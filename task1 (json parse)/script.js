window.onload = function() {
	...
	function historicalLifeExpectancy(json, century) {
		...
		if (localArrayAge.length) {
			return century + ': ' + '' + average(localArrayAge).toFixed(2) + ' average age';
		}

		else {
			return century + ' century is not found.';
		}


	}

	console.log(historicalLifeExpectancy(ANCESTRY, 19)); // OUTPUT RESULT
